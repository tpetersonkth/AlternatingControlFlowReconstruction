...
;Example: Can be used as an example for when strided interval analysis would be useful in theory.
...
_start:
        ...
        and eax, 0x00A00000     ; eax = [0,10mb]1mb (However, only happens in theory..)
jump:
        jmp eax
